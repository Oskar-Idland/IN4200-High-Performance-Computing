/**
 * @brief A utility function to handle input arguments for the program. Checks for valid number of arguments and values. If none are provided, default values are used.
